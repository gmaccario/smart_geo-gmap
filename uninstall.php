...
array_map('unlink', glob(SMART_GEO_GMAP_PATH_DATA . "/*.*"));
rmdir(SMART_GEO_GMAP_PATH_DATA);

array_map('unlink', glob(SMART_GEO_GMAP_PATH_SNAZZY_STYLE . "/*.*"));
rmdir(SMART_GEO_GMAP_PATH_SNAZZY_STYLE);